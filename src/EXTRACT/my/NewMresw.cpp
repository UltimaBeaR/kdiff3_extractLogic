...
QScrollBar* NewMresw::mVScrollBar = nullptr;
QPointer<QAction> NewMresw::chooseAEverywhere;
QPointer<QAction> NewMresw::chooseBEverywhere;
QPointer<QAction> NewMresw::chooseCEverywhere;
QPointer<QAction> NewMresw::chooseAForUnsolvedConflicts;
QPointer<QAction> NewMresw::chooseBForUnsolvedConflicts;
QPointer<QAction> NewMresw::chooseCForUnsolvedConflicts;
QPointer<QAction> NewMresw::chooseAForUnsolvedWhiteSpaceConflicts;
QPointer<QAction> NewMresw::chooseBForUnsolvedWhiteSpaceConflicts;
QPointer<QAction> NewMresw::chooseCForUnsolvedWhiteSpaceConflicts;
    ...
    : QWidget(pParent)
{
    ...
    if(m_pStatusBar != nullptr)
        chk_connect(m_pStatusBar, &QStatusBar::messageChanged, this, &NewMresw::slotStatusMessageChanged);

    m_pOptions = pOptions;
    setUpdatesEnabled(false);

    chk_connect(&m_cursorTimer, &QTimer::timeout, this, &NewMresw::slotCursorUpdate);
...
void NewMresw::initActions(KActionCollection* ac)
{
    if(ac == nullptr)
    {
...
void NewMresw::connectActions() const
{
    chk_connect(chooseAEverywhere, &QAction::triggered, this, &NewMresw::slotChooseAEverywhere);
    chk_connect(chooseBEverywhere, &QAction::triggered, this, &NewMresw::slotChooseBEverywhere);
    chk_connect(chooseCEverywhere, &QAction::triggered, this, &NewMresw::slotChooseCEverywhere);

    chk_connect(chooseAForUnsolvedConflicts, &QAction::triggered, this, &NewMresw::slotChooseAForUnsolvedConflicts);
    chk_connect(chooseBForUnsolvedConflicts, &QAction::triggered, this, &NewMresw::slotChooseBForUnsolvedConflicts);
    chk_connect(chooseCForUnsolvedConflicts, &QAction::triggered, this, &NewMresw::slotChooseCForUnsolvedConflicts);

    chk_connect(chooseAForUnsolvedWhiteSpaceConflicts, &QAction::triggered, this, &NewMresw::slotChooseAForUnsolvedWhiteSpaceConflicts);
    chk_connect(chooseBForUnsolvedWhiteSpaceConflicts, &QAction::triggered, this, &NewMresw::slotChooseBForUnsolvedWhiteSpaceConflicts);
    chk_connect(chooseCForUnsolvedWhiteSpaceConflicts, &QAction::triggered, this, &NewMresw::slotChooseCForUnsolvedWhiteSpaceConflicts);
}

void NewMresw::setupConnections(const KDiff3App* app)
{
    chk_connect(app, &KDiff3App::cut, this, &NewMresw::slotCut);
    chk_connect(app, &KDiff3App::copy, this, &NewMresw::slotCopy);
    chk_connect(app, &KDiff3App::selectAll, this, &NewMresw::slotSelectAll);

    chk_connect(this, &NewMresw::scrollMergeResultWindow, app, &KDiff3App::scrollMergeResultWindow);
    chk_connect(this, &NewMresw::sourceMask, app, &KDiff3App::sourceMask);
    chk_connect(this, &NewMresw::resizeSignal, app, &KDiff3App::setHScrollBarRange);
    chk_connect(this, &NewMresw::resizeSignal, this, &NewMresw::slotResize);

    chk_connect(this, &NewMresw::selectionEnd, app, &KDiff3App::slotSelectionEnd);
    chk_connect(this, &NewMresw::newSelection, app, &KDiff3App::slotSelectionStart);
    chk_connect(this, &NewMresw::modifiedChanged, app, &KDiff3App::slotOutputModified);
    chk_connect(this, &NewMresw::updateAvailabilities, app, &KDiff3App::slotUpdateAvailabilities);
    chk_connect(this, &NewMresw::showPopupMenu, app, &KDiff3App::showPopupMenu);
    chk_connect(this, &NewMresw::noRelevantChangesDetected, app, &KDiff3App::slotNoRelevantChangesDetected);
    chk_connect(this, &NewMresw::statusBarMessage, app, &KDiff3App::slotStatusMsg);
    //connect menu actions
    chk_connect(app, &KDiff3App::showWhiteSpaceToggled, this, static_cast<void (NewMresw::*)(void)>(&NewMresw::update));
    chk_connect(app, &KDiff3App::doRefresh, this, &NewMresw::slotRefresh);

    chk_connect(app, &KDiff3App::autoSolve, this, &NewMresw::slotAutoSolve);
    chk_connect(app, &KDiff3App::unsolve, this, &NewMresw::slotUnsolve);
    chk_connect(app, &KDiff3App::mergeHistory, this, &NewMresw::slotMergeHistory);
    chk_connect(app, &KDiff3App::regExpAutoMerge, this, &NewMresw::slotRegExpAutoMerge);

    chk_connect(app, &KDiff3App::goCurrent, this, &NewMresw::slotGoCurrent);
    chk_connect(app, &KDiff3App::goTop, this, &NewMresw::slotGoTop);
    chk_connect(app, &KDiff3App::goBottom, this, &NewMresw::slotGoBottom);
    chk_connect(app, &KDiff3App::goPrevUnsolvedConflict, this, &NewMresw::slotGoPrevUnsolvedConflict);
    chk_connect(app, &KDiff3App::goNextUnsolvedConflict, this, &NewMresw::slotGoNextUnsolvedConflict);
    chk_connect(app, &KDiff3App::goPrevConflict, this, &NewMresw::slotGoPrevConflict);
    chk_connect(app, &KDiff3App::goNextConflict, this, &NewMresw::slotGoNextConflict);
    chk_connect(app, &KDiff3App::goPrevDelta, this, &NewMresw::slotGoPrevDelta);
    chk_connect(app, &KDiff3App::goNextDelta, this, &NewMresw::slotGoNextDelta);

    chk_connect(app, &KDiff3App::changeOverViewMode, this, &NewMresw::setOverviewMode);

    connections.push_back(KDiff3App::allowCut.connect(boost::bind(&NewMresw::canCut, this)));
    connections.push_back(KDiff3App::allowCopy.connect(boost::bind(&NewMresw::canCopy, this)));
    connections.push_back(KDiff3App::getSelection.connect(boost::bind(&NewMresw::getSelection, this)));
}

void NewMresw::slotResize()
{
    mVScrollBar->setRange(0, std::max(0, getNofLines() - getNofVisibleLines()));
    mVScrollBar->setPageStep(getNofVisibleLines());
}

void NewMresw::slotCut()
{
...
void NewMresw::showUnsolvedConflictsStatusMessage()
{
    if(m_pStatusBar != nullptr)
    {
        int wsc;
...
void NewMresw::slotRefresh()
{
    setFont(m_pOptions->m_font);
    update();
}

void NewMresw::slotUpdateAvailabilities()
{
...
void NewMresw::slotStatusMessageChanged(const QString& s)
{
...
bool NewMresw::sameKindCheck(const MergeLine& ml1, const MergeLine& ml2)
{
...
void NewMresw::setFirstLine(QtNumberType firstLine)
{
    m_firstLine = std::max(0, firstLine);
    update();
}

void NewMresw::setHorizScrollOffset(int horizScrollOffset)
{
    m_horizScrollOffset = std::max(0, horizScrollOffset);
    update();
}

int NewMresw::getMaxTextWidth()
{
    if(m_maxTextWidth < 0)
    {
        m_maxTextWidth = 0;
...
int NewMresw::getNofLines() const
{
    return m_nofLines;
}

int NewMresw::getVisibleTextAreaWidth()
{
    return width() - getTextXOffset();
}

int NewMresw::getNofVisibleLines()
{
    QFontMetrics fm = fontMetrics();
    return (height() - 3) / fm.lineSpacing() - 2;
}

int NewMresw::getTextXOffset()
{
    QFontMetrics fm = fontMetrics();
    return 3 * Utils::getHorizontalAdvance(fm, '0');
}

void NewMresw::resizeEvent(QResizeEvent* e)
{
    QWidget::resizeEvent(e);
    Q_EMIT resizeSignal();
}

e_OverviewMode NewMresw::getOverviewMode()
{
    return mOverviewMode;
}

void NewMresw::setOverviewMode(e_OverviewMode eOverviewMode)
{
    mOverviewMode = eOverviewMode;
}

// Check whether we should ignore current delta when moving to next/previous delta
bool NewMresw::checkOverviewIgnore(MergeLineList::iterator& i)
{
...
void NewMresw::go(e_Direction eDir, e_EndPoint eEndPoint)
{
...
bool NewMresw::isDeltaAboveCurrent()
{
    bool bSkipWhiteConflicts = !m_pOptions->m_bShowWhiteSpace;
...
bool NewMresw::isDeltaBelowCurrent()
{
    bool bSkipWhiteConflicts = !m_pOptions->m_bShowWhiteSpace;
    if(m_mergeLineList.empty()) return false;
...
bool NewMresw::isConflictAboveCurrent()
{
    if(m_mergeLineList.empty()) return false;
    MergeLineList::iterator i = m_currentMergeLineIt;
    if(i == m_mergeLineList.begin()) return false;
...
bool NewMresw::isConflictBelowCurrent()
{
    MergeLineList::iterator i = m_currentMergeLineIt;
    if(m_mergeLineList.empty()) return false;
...
bool NewMresw::isUnsolvedConflictAtCurrent()
{
    if(m_mergeLineList.empty()) return false;
    MergeLineList::iterator i = m_currentMergeLineIt;
...
bool NewMresw::isUnsolvedConflictAboveCurrent()
{
    if(m_mergeLineList.empty()) return false;
    MergeLineList::iterator i = m_currentMergeLineIt;
    if(i == m_mergeLineList.begin()) return false;
...
bool NewMresw::isUnsolvedConflictBelowCurrent()
{
    MergeLineList::iterator i = m_currentMergeLineIt;
    if(m_mergeLineList.empty()) return false;
...
void NewMresw::slotGoTop()
{
    go(eUp, eEnd);
}

void NewMresw::slotGoCurrent()
{
    setFastSelector(m_currentMergeLineIt);
}

void NewMresw::slotGoBottom()
{
    go(eDown, eEnd);
}

void NewMresw::slotGoPrevDelta()
{
    go(eUp, eDelta);
}

void NewMresw::slotGoNextDelta()
{
    go(eDown, eDelta);
}

void NewMresw::slotGoPrevConflict()
{
    go(eUp, eConflict);
}

void NewMresw::slotGoNextConflict()
{
    go(eDown, eConflict);
}

void NewMresw::slotGoPrevUnsolvedConflict()
{
    go(eUp, eUnsolvedConflict);
}

void NewMresw::slotGoNextUnsolvedConflict()
{
...
void NewMresw::slotSetFastSelectorLine(LineIndex line)
{
    MergeLineList::iterator i;
    for(i = m_mergeLineList.begin(); i != m_mergeLineList.end(); ++i)
    {
...
int NewMresw::getNrOfUnsolvedConflicts(int* pNrOfWhiteSpaceConflicts)
{
    int nrOfUnsolvedConflicts = 0;
...
void NewMresw::showNrOfConflicts()
{
...
void NewMresw::setFastSelector(MergeLineList::iterator i)
{
    if(i == m_mergeLineList.end())
        return;
...
void NewMresw::choose(e_SrcSelector selector)
{
...
void NewMresw::chooseGlobal(e_SrcSelector selector, bool bConflictsOnly, bool bWhiteSpaceOnly)
{
    resetSelection();
...
void NewMresw::collectHistoryInformation(
...
MergeEditLineList& NewMresw::HistoryMapEntry::choice(bool bThreeInputs)
{
    if(!bThreeInputs)
...
bool NewMresw::HistoryMapEntry::staysInPlace(bool bThreeInputs, Diff3LineList::const_iterator& iHistoryEnd)
{
...
void NewMresw::slotMergeHistory()
{
...
void NewMresw::slotRegExpAutoMerge()
{
...
bool NewMresw::doRelevantChangesExist()
{
...
MergeLineList::iterator NewMresw::splitAtDiff3LineIdx(int d3lLineIdx)
{
    MergeLineList::iterator i;
    for(i = m_mergeLineList.begin(); i != m_mergeLineList.end(); ++i)
    {
...
void NewMresw::slotSplitDiff(int firstD3lLineIdx, int lastD3lLineIdx)
{
    if(lastD3lLineIdx >= 0)
...
void NewMresw::slotJoinDiffs(int firstD3lLineIdx, int lastD3lLineIdx)
{
    MergeLineList::iterator i;
...
void NewMresw::myUpdate(int afterMilliSecs)
{
...
void NewMresw::timerEvent(QTimerEvent*)
{
    killTimer(m_delayedDrawTimer);
...
QVector<QTextLayout::FormatRange> NewMresw::getTextLayoutForLine(int line, const QString& str, QTextLayout& textLayout)
{
    // tabs
...
void NewMresw::setPaintingAllowed(bool bPaintingAllowed)
{
...
void NewMresw::paintEvent(QPaintEvent*)
{
...
void NewMresw::updateSourceMask()
{
    int srcMask = 0;
    int enabledMask = 0;
...
void NewMresw::focusInEvent(QFocusEvent* e)
{
    updateSourceMask();
    QWidget::focusInEvent(e);
}

LineRef NewMresw::convertToLine(int y)
{
    const QFontMetrics& fm = fontMetrics();
    int fontHeight = fm.lineSpacing();
    int topLineYOffset = 0;
...
void NewMresw::mousePressEvent(QMouseEvent* e)
{
    m_bCursorOn = true;
...
void NewMresw::mouseDoubleClickEvent(QMouseEvent* e)
{
...
void NewMresw::mouseReleaseEvent(QMouseEvent* e)
{
    if(e->button() == Qt::LeftButton)
    {
        if(m_delayedDrawTimer)
...
void NewMresw::mouseMoveEvent(QMouseEvent* e)
{
    LineRef line = convertToLine(e->y());
    QString s = getString(line);
    QTextLayout textLayout(s, font(), this);
...
void NewMresw::slotCursorUpdate()
{
    m_cursorTimer.stop();
...
void NewMresw::wheelEvent(QWheelEvent* pWheelEvent)
{
...
void NewMresw::keyPressEvent(QKeyEvent* e)
{
    int y = m_cursorYPos;
    MergeLineList::iterator mlIt;
    MergeEditLineList::iterator melIt;
 ...
 */
bool NewMresw::calcIteratorFromLineNr(
    int line,
    MergeLineList::iterator& mlIt,
    MergeEditLineList::iterator& melIt)
{
...
bool NewMresw::deleteSelection2(QString& s, int& x, int& y,
...
void NewMresw::pasteClipboard(bool bFromSelection)
{
...
void NewMresw::resetSelection()
{
    m_selection.reset();
    update();
}

void NewMresw::setModified(bool bModified)
{
...
bool NewMresw::saveDocument(const QString& fileName, QTextCodec* pEncoding, e_LineEndStyle eLineEndStyle)
{
...
QString NewMresw::getString(int lineIdx)
{
    MergeLineList::iterator mlIt;
    MergeEditLineList::iterator melIt;
...
bool NewMresw::findString(const QString& s, LineRef& d3vLine, int& posInLine, bool bDirDown, bool bCaseSensitive)
{
    int it = d3vLine;
...
void NewMresw::setSelection(int firstLine, int startPos, int lastLine, int endPos)
{
...
void NewMresw::scrollVertically(QtNumberType deltaY)
{
